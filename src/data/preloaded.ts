...
export const PRELOADED_PM_PLANS = [
  {
    id: "plan-pm-sli01",
    machineId: "SLI01",
    title: "ใบรายงาน Preventive Maintenance (PM) - เครื่องหั่นผัก (Food Slicer)",
    frequency: "รายเดือน" as const,
    ttm: 120,
    spareParts: "ลูกปืนมีด 6006 (2 ตลับ), ลูกปืนเฟือง 6003 (4 ตลับ)",
    sparePartsQty: "6 ตลับ",
    inspectorTech: "สมศักดิ์ ช่างเครื่อง",
    acknowledgingDept: "วิชัย หัวหน้ากะผลิต",
    supervisorName: "ธีระพงษ์ วิศวกร PM",
    ...
    steps: [
      ...
      },
      {
        ...
        abnormalDetail: "วัดได้ 220V ครบ 3 เฟส สมดุล",
        remark: ""
      },
      {
        id: "step-sli-03",
        ...
        method: "เครื่องมือวัด",
        standard: "กระแสไฟฟ้า ไม่เกิน 1.15 A.... (บันทึกค่าที่วัดได้) L, M1, M2, H ที่ความหนา 2.3 mm",
        frequency: "1 เดือน/ครั้ง",
        stdTime: 15,
        result: "ปกติ",
        done: true,
        abnormalDetail: "L: 0.95A, M1: 0.98A, M2: 1.02A, H: 1.08A (ไม่เกิน 1.15A)",
        remark: "มอเตอร์ขับสายพาน 0.2KW"
      },
      {
        id: "step-sli-04",
        itemNo: 4,
        title: "ตรวจวัดค่ากระแสไฟฟ้า มอเตอร์ขับใบมีด 1.75 KW",
        method: "เครื่องมือวัด",
        standard: "กระแสไฟฟ้า ไม่เกิน 4.3 A..... (บันทึกค่าที่วัดได้) L, M1, M2, H ที่ความหนา 2.3 mm",
        frequency: "1 เดือน/ครั้ง",
        stdTime: 15,
        result: "ปกติ",
        done: true,
        abnormalDetail: "L: 3.8A, M1: 3.9A, M2: 4.1A, H: 4.15A (ไม่เกิน 4.3A)",
        remark: "มอเตอร์ขับใบมีด 1.75 KW"
      },
      {
        id: "step-sli-05",
        itemNo: 5,
        title: "ตรวจเช็คสภาพมอเตอร์",
        method: "ดูด้วยสายตา",
        standard: "5.1 สภาพสมบูรณ์ 5.2 ไม่มีสนิมและคราบสกปรก 5.3 ไม่มีส่วนชำรุด",
        frequency: "1 เดือน/ครั้ง",
        stdTime: 10,
        result: "ปกติ",
        done: true,
      ...
      },
      {
        id: "step-sli-06",
        itemNo: 6,
        title: "ขันย้ำ น็อตขั้วสายไฟและSocketภายในชุดคอนโทรล",
        method: "เครื่องมือ",
        standard: "จุดยึดต่อระบบไฟต้องแน่น ไม่หลวม",
        frequency: "1 เดือน/ครั้ง",
        stdTime: 10,
        result: "ปกติ",
        done: true,
        abnormalDetail: "ขันย้ำจุดต่อ 12 จุด แน่นหนาทุกตำแหน่ง",
        remark: ""
      },
      {
        id: "step-sli-07",
        itemNo: 7,
        title: "เช็คสภาพสายไฟและจุดต่อเชื่อมสาย",
        method: "ดูด้วยสายตา เครื่องมือ",
        standard: "7.1 สายไฟไม่ชำรุด 7.2 วัดสายไฟ ไม่ขาด ไฟมาครบ Phase",
        frequency: "1 เดือน/ครั้ง",
        stdTime: 10,
        result: "ปกติ",
        done: true,
        abnormalDetail: "สายไฟสมบูรณ์ ฉนวนไม่กรอบแตก",
        remark: ""
      },
      {
        id: "step-sli-08",
        itemNo: 8,
        title: "ตรวจเช็คสายกราวด์",
        method: "เครื่องมือวัด",
        standard: "มีการต่อระบบกราวด์ (เครื่อง, สาย, โครง)",
        frequency: "1 เดือน/ครั้ง",
        stdTime: 10,
        result: "ปกติ",
        done: true,
        abnormalDetail: "ความต้านทานกราวด์ < 5 โอห์ม",
        remark: ""
      },
      {
        id: "step-sli-09",
        itemNo: 9,
        title: "ตรวจเช็คสภาพสายพานเข้า-ออก",
        method: "มือ สายตา",
        standard: "9.1 โครงสร้างของชุดสายพาน มีสภาพสมบูรณ์ ไม่ฝืด 9.2 สายพานไม่หย่อน และมีสภาพสมบูรณ์ไม่มีรอยฉีกขาด",
        frequency: "1 เดือน/ครั้ง",
        stdTime: 10,
        result: "ปกติ",
        done: false,
      ...
      },
      {
        ...
        method: "มือ สายตา",
        standard: "10.1 ใบมีดมีความคมและยึดแน่น 10.2 ใบมีดไม่มีส่วนใดชำรุด บิ่น",
        frequency: "1 เดือน/ครั้ง",
        stdTime: 15,
        result: "ปกติ",
        done: false,
      ...
      },
      {
        id: "step-sli-11",
        itemNo: 11,
        title: "ตรวจเช็คสภาพเฟืองและโซ่",
        method: "มือ สายตา",
        standard: "11.1 เฟืองมีสภาพสมบูรณ์ไม่สึกไม่โยก 11.2 โซ่ไม่หย่อนและมีสภาพสมบูรณ์",
        frequency: "1 เดือน/ครั้ง",
        stdTime: 15,
        result: "ยังไม่ตรวจ",
        done: false,
        abnormalDetail: "",
        remark: "ลูกปืนเฟือง 6003 4 ตลับ"
      },
      {
        id: "step-sli-14",
        itemNo: 14,
        ...
        method: "มือ สายตา",
        standard: "14.1 ภายในเครื่องต้องสะอาด 14.2 ภายนอกเครื่องต้องสะอาด 14.3 ตู้ควบคุม ต้องสะอาด ไม่มีความชื้น",
        frequency: "1 เดือน/ครั้ง",
        stdTime: 10,
        result: "ยังไม่ตรวจ",
        done: false,
      ...
      },
      {
        ...
        method: "ประสาทสัมผัส",
        standard: "15.1 เสียงมอเตอร์ต้องปกติ 15.2 โครงสร้างไม่สั่นสะเทือน ชุดโซ่ส่งกำลังสายพาน ไม่กระตุก 15.3 ปุ่ม Emergency ใช้งานได้ปกติ 15.4 Sensor การ์ดครอบทำงานปกติทั้ง 3 จุด (เข้า-ออก-ลับมีด)",
        frequency: "1 เดือน/ครั้ง",
        stdTime: 15,
        result: "ยังไม่ตรวจ",
        done: false,
