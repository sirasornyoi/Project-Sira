...
export const CD5UsageHistoryModal: React.FC<CD5UsageHistoryModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-bg/85 backdrop-blur-sm flex items-center justify-center p-3 sm:p-6 overflow-y-auto" id="cd5-usage-history-modal">
      ...
      {/* CONFIRMATION FOR DELETING USAGE HISTORY ENTRY */}
      {entryToDelete && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-slate-950/80 backdrop-blur-sm p-4 animate-in fade-in duration-100">
          <div id="modal-delete-cd5-entry-confirm" className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-750 rounded-2xl max-w-sm w-full p-6 space-y-5 shadow-2xl">
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100">
                ลบบันทึกประวัติรอบนี้?
              </h3>
              <p className="text-xs text-slate-500 dark:text-slate-400">
                คุณแน่ใจหรือไม่ว่าต้องการลบบันทึกประวัติการใช้งานรอบนี้ออกจากโครงการ?
              </p>
            </div>
            <div className="flex gap-3 justify-end text-xs font-bold">
              <button
                type="button"
                id="btn-cancel-delete-cd5-entry"
              ...
              <button
                type="button"
                id="btn-confirm-delete-cd5-entry"
